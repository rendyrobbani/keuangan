...
public final class SipdMasterBidangTable {

	public static final String NAME = "sipd_master_bidang";
	...
	private static List<Column> getColumns() {
		if (columns == null) {
			...
			columns.add(ColumnFactory.createBidangCode("data_id", false));
		}
		return columns;
	}
	...
	public static List<ForeignKeyConstraint> getForeignKeys() {
		if (foreignKeys == null) {
			...
			foreignKeys.add(ForeignKeyConstraintFactory.create(NAME, foreignKeys.size() + 1, "data_id", DataMasterBidangTable.NAME, "id"));
		}
		return foreignKeys;
	}
