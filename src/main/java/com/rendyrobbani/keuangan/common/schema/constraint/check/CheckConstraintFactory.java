...
public final class CheckConstraintFactory {
	...
	public static CheckConstraint create(
			String name,
			String logic) {
	...
	public static CheckConstraint columnRegex(
			String tableName,
			Integer index,
			String columnName,
			String regex) {
	...
	public static CheckConstraint columnIn(
			String tableName,
			Integer index,
			String columnName,
			String[] values) {
	...
	public static CheckConstraint columnBetween(
			String tableName,
			Integer index,
			String columnName,
			Integer min,
	...
	public static CheckConstraint columnIsNip(
			String tableName,
			Integer index,
			String columnName) {
	...
	public static CheckConstraint columnPangkat(
			String tableName,
			Integer index,
			String columnName) {
	...
	public static CheckConstraint columnGender(
			String tableName,
			Integer index,
			String columnName) {
