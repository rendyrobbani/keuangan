...
import com.rendyrobbani.keuangan.application.web.record.user.WebUserDataCreateRequestRecord;
import com.rendyrobbani.keuangan.application.web.record.user.WebUserDataUpdateRequestRecord;
...
public class WebUserController {
	...
	public ResponseEntity<?> create(@RequestBody WebUserDataCreateRequestRecord request) {
	...
	public ResponseEntity<?> update(@PathVariable String id,
	                                @RequestBody WebUserDataUpdateRequestRecord request) {
		authorizationService.hasInRole(Role.PPKD);
	...
	@PatchMapping("/web/user/{id}/unlock")
