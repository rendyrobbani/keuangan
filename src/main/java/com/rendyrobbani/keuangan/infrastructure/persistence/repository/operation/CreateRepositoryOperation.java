...
public interface CreateRepositoryOperation<ID, DOMAIN extends Base<ID>, ENTITY extends BaseEntity<ID, DOMAIN>> extends CreateRepository<DOMAIN>,
	...
	default DOMAIN create(DOMAIN domain, LocalDateTime createdAt, Nip createdBy) {
		...
		return this.repository().save(this.mapper().create(domain, createdAt, createdBy)).toDomain();
	}
